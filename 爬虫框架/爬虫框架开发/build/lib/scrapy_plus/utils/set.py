...
from scrapy_plus.conf.settings import REDIS_SET_NAME,REDIS_SET_HOST,REDIS_SET_PORT,REDIS_SET_DB
...
class RedisFilterContainer(BaseFilterContainer):
    ...
    def __init__(self):
        self._redis = redis.StrictRedis(host=REDIS_SET_HOST, port=REDIS_SET_PORT, db=REDIS_SET_DB, password=None)
