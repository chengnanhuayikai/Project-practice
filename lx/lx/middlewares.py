...
class LxSpiderMiddleware(object):
...
class LxDownloaderMiddleware(object):
    # Not all methods need to be defined. If a method is not defined,
...
class ProxyMiddlerware(object):
    ...
    def get_proxy(self):
        res_1 = requests.get('http://127.0.0.1:8080/get/')
        # try:
        #     res_2 = requests.get('http://icanhazip.com',
        #                    proxies={"http": "http://{}".format(res_1.text)}, timeout=2)
        # except:
        #     print('------------>	1')
        #     self.get_proxy()
        # if len(res_2.text) < 20:
        #     print('------------>	2')
        #     print(res_1.text)
        #     return res_1.text
        #
