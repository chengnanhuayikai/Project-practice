...
var utils = {
    ...
    cssSupport: function(type) {
        return {
            ...
            transition: function() {
                for (var el = document.createElement("div"), prefix = ["transition", "mozTransition", "msTransition", "webkitTransition"], result = !1, i = 0, len = prefix.length; i < len; i++)
    ...
    getCss3Prefix: function(css) {
        for (var el = document.createElement("div"), cssUpper = css.toUpperCase(), prefix = [css, "moz" + cssUpper, "ms" + cssUpper, "webkit" + cssUpper], i = 0, len = prefix.length; i < len; i++)
            if (prefix[i]in el.style)
                return prefix[i];
        return css
    },
    create_object: function(obj) {
        function f() {}
        return void 0 === Object.create ? (f.prototype = obj,
        new f) : Object.create(obj)
    },
  ...
  , Base64 = {
    ...
    _utf8_decode: function(utftext) {
        for (var string = "", i = 0, c = c1 = c2 = 0; i < utftext.length; )
            ...
            c < 128 ? (string += String.fromCharCode(c),
  ...
  , sha1 = function() {
    ...
    return function(string) {
        var blockstart, i, j, A, B, C, D, E, tempValue, W = new Array(80), H0 = 1732584193, H1 = 4023233417, H2 = 2562383102, H3 = 271733878, H4 = 3285377520;
  ...
  , Cookie = {
    getItem: function(name) {
        var cookieEnd, cookieName = encodeURIComponent(name) + "=", cookieStart = document.cookie.indexOf(cookieName), cookieValue = null;
        return cookieStart > -1 && (cookieEnd = document.cookie.indexOf(";", cookieStart),
        -1 == cookieEnd && (cookieEnd = document.cookie.length),
    ...
    setItem: function(name, value, time) {
        var cookieText = encodeURIComponent(name) + "=" + encodeURIComponent(value) + "; path=/"
          , date = new Date;
        void 0 != time && (date.setTime(date.getTime() + time),
